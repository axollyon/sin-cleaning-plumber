...
extern const BehaviorScript bhvZeroNineThree[];
extern const BehaviorScript bhvQuestionMark[];
extern const BehaviorScript bhvRope[];
extern const BehaviorScript bhvUncleanFigure[];
